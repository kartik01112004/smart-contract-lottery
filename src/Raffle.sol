...
contract Raffle is VRFConsumerBaseV2Plus {
     ...
     * if its time for winner to be picekd.
     * the following needs to be true in order for upkeepNeeded to be true:
     * 1. the time interval has passed between raffle runs
     * 2. the lottery is open
     * 3. the contract has eth
     * 4. implicitly, the your subscrpition has link
     * @param - ignored
    ...
    function fulfillRandomWords(uint256, /*requestId*/ uint256[] calldata randomWords) internal override {
        ...
        s_raffleState = RaffleState.OPEN;
        s_players = new address payable[](0); //reset the array to empty
        s_lastTimeStamp = block.timestamp; //restart the clock to pic winner
